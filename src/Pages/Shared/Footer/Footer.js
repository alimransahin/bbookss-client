...
const Footer = () => {
    return (
        <footer className="footer p-10 bg-indigo-200">
            <div>
                <img src="https://i.ibb.co/VNLzn9w/Screenshot-3-removebg-preview.png" alt="logo" />
                <p>BbooksS Ltd.<br />Providing reliable tech since 2000</p>
            </div>
            <div>
